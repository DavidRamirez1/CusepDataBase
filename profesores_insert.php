...
<head>
  <title>CUSEP - Profesores Insert</title>
  ...
  <div id="main">
    ...
    <div id="site_content">
      <div id="content">
        ...
        <h1>Informacion de Profesor Nuevo</h1>
        <form action="profesores_insertconf.php" method="post">
          Nombre: <input type="text" name="nombre_profesor"/><br></br>
          Apellido: <input type="text" name="apellido_profesor"/><br></br>
